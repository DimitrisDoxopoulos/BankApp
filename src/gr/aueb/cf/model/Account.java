...
public class Account extends IdentifiableEntity {
     ...
     * @throws IsNotValidException
     * @throws NegativeAmountException
     */
    public void withdraw (double amount, String ssn)
            throws InsufficientBalanceException, IsNotValidException, NegativeAmountException {
        try {
            if (amount < 0) throw new NegativeAmountException(amount);
            ...
            balance -= amount;
        } catch (InsufficientBalanceException | IsNotValidException | NegativeAmountException e) {
